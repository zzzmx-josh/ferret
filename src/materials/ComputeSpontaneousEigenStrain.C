...
registerMooseObject("FerretApp", ComputeSpontaneousEigenStrain);
InputParameters ComputeSpontaneousEigenStrain::validParams()
{
...
ComputeSpontaneousEigenStrain::ComputeSpontaneousEigenStrain(const InputParameters & parameters) :
...
void
ComputeSpontaneousEigenStrain::computeQpEigenstrain()
{
