...
class PMP_Ferroelectrics_SP_ComputeStress;

class PMP_Ferroelectrics_SP_ComputeStress:public ComputeStressBase
{
public:
    static InputParameters validParams();
    PMP_Ferroelectrics_SP_ComputeStress(const InputParameters &parameters);
