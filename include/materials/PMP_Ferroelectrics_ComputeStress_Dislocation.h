...
class PMP_Ferroelectrics_ComputeStress_Dislocation;

class PMP_Ferroelectrics_ComputeStress_Dislocation:public ComputeStressBase
{
public:
    static InputParameters validParams();
    PMP_Ferroelectrics_ComputeStress_Dislocation(const InputParameters &parameters);
