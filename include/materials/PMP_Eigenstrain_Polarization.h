...
class PMP_Eigenstrain_Polarization;

class PMP_Eigenstrain_Polarization : public ComputeEigenstrainBase
{
public:
    static InputParameters validParams();
    PMP_Eigenstrain_Polarization (const InputParameters & parameters);
...
protected:
    ...
    const MaterialProperty<RankFourTensor> &_Q;
};
