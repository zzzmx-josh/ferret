...
class PMP_FE_ComputeStress_Dislocation;

class PMP_FE_ComputeStress_Dislocation:public ComputeStressBase
{
public:
    static InputParameters validParams();
    PMP_FE_ComputeStress_Dislocation(const InputParameters &parameters);
